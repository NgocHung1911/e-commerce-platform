<?php
/**
 * Theme Template Part: Trang Liên Hệ & Bản Đồ Google Maps
 * Path: template-parts/cpm/contact-page.php
 */

if (!defined('ABSPATH')) {
    exit;
}
// Passed variables: $user_name, $user_email
?>
                ...
                <div class="bg-white rounded-3xl p-6 md:p-8 border border-slate-200/80 shadow-xl space-y-6">
                    ...
                    <div class="space-y-5 text-sm">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h4 class="font-extrabold text-slate-900 text-xs uppercase tracking-wider text-slate-400">Email Hỗ Trợ</h4>
